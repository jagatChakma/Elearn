 ...
 */
public class BanjonbornoFragment7 extends Fragment {
    private TextView banjonbornoText;
    private ImageView imageView1, imageView2, imageView3, imageView4;
    private CanvasView canvasView;


    public BanjonbornoFragment7() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_banjonborno_fragment7, container, false);

        final MediaPlayer mp3 = MediaPlayer.create(getActivity(),R.raw.bng_mp3_7);
        final MediaPlayer mp33 = MediaPlayer.create(getActivity(),R.raw.bng_dilog7);
