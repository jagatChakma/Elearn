 ...
 */
public class BanjonbornoFragment12 extends Fragment {
    private TextView banjonbornoText;
    private ImageView imageView1, imageView2, imageView3, imageView4;
    private CanvasView canvasView;


    public BanjonbornoFragment12() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_banjonborno_fragment12, container, false);

        final MediaPlayer mp3 = MediaPlayer.create(getActivity(),R.raw.bng_mp3_12);
        final MediaPlayer mp33 = MediaPlayer.create(getActivity(),R.raw.bng_dilog12);
