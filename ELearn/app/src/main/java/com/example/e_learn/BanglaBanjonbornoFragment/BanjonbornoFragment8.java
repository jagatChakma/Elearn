 ...
 */
public class BanjonbornoFragment8 extends Fragment {
    private TextView banjonbornoText;
    private ImageView imageView1, imageView2, imageView3, imageView4;
    private CanvasView canvasView;


    public BanjonbornoFragment8() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_banjonborno_fragment8, container, false);
        final MediaPlayer mp3 = MediaPlayer.create(getActivity(),R.raw.bng_mp3_8);
        final MediaPlayer mp33 = MediaPlayer.create(getActivity(),R.raw.bng_dilog8);
