 ...
 */
public class BanjonbornoFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_banjonborno_fragment3, container, false);

        final MediaPlayer mp3 = MediaPlayer.create(getActivity(),R.raw.bng_mp3_3);
        final MediaPlayer mp33 = MediaPlayer.create(getActivity(),R.raw.bng_dilog4);
