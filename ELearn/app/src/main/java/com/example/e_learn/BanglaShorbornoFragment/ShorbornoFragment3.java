 ...
 */
public class ShorbornoFragment3 extends Fragment {
    private TextView sarobornoText;
    private ImageView imageView1, imageView2, imageView3, imageView4;
    private CanvasView canvasView;


    public ShorbornoFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_shorborno_fragment3, container, false);
        final CanvasView canvasView = (CanvasView)view.findViewById(R.id.canvasViewId);
        //here is audio code

        final MediaPlayer mp3 = MediaPlayer.create(getActivity(),R.raw.sa_mp3_3);
        final MediaPlayer mp33 = MediaPlayer.create(getActivity(),R.raw.sa_dilog3);
